...
- [X] yasnippet
- [X] show full path in frame title
- [X] turn on tern-mode for .jsx files
- [X] run js2 flycheckers when in .jsx file in web-mode
- [X] add ' to web-mode electric pairs
- [X] disable js flycheckers and tern in non-jsx web-mode files
